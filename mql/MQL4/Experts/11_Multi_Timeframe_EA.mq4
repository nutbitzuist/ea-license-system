...
input int      MagicNumber = 100011;     // Magic Number
...
int OnInit()
{
   Print("=== Multi-Timeframe EA v1.0.0 ===");
   ...
   Print("Multi-Timeframe EA initialized and ready to trade");
   return INIT_SUCCEEDED;
}

void OnDeinit(const int reason)
{
   Print("Multi-Timeframe EA stopped. Reason: ", reason);
}
...
void OpenOrder(int orderType)
{
   ...
   int ticket = OrderSend(Symbol(), orderType, tradeVolume, price, 10, sl, tp, "MTF EA", MagicNumber, 0, clrNONE);

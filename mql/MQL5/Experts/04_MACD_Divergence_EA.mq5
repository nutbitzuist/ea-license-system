...
#define LICENSE_EA_CODE "macd_divergence_ea"
...
int OnInit()
{
   Print("=== MACD Divergence EA v1.0.0 ===");
   ...
   Print("MACD Divergence EA initialized and ready to trade");
...
void OnDeinit(const int reason)
{
   ...
   Print("MACD Divergence EA stopped. Reason: ", reason);
}

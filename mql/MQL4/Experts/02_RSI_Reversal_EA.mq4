...
#define LICENSE_EA_CODE "rsi_reversal_ea"
...
int OnInit()
{
   ...
   Print("RSI Reversal EA initialized and ready to trade");
...
{
   Print("RSI Reversal EA stopped. Reason: ", reason);
}
...
void OpenOrder(int orderType)
{
   ...
   int ticket = OrderSend(Symbol(), orderType, tradeVolume, price, 10, sl, tp, "RSI Reversal", MagicNumber, 0, clrNONE);

...
#define LICENSE_EA_CODE "support_resistance_ea"
...
input int      ZonePoints = 50;          // Zone Size (points)
...
int OnInit()
{
   Print("=== Support/Resistance EA v1.0.0 ===");
   ...
   Print("Support/Resistance EA initialized and ready to trade");
   return INIT_SUCCEEDED;
}

void OnDeinit(const int reason)
{
   Print("Support/Resistance EA stopped. Reason: ", reason);
}
...
void OpenOrder(int orderType)
{
   ...
   int ticket = OrderSend(Symbol(), orderType, tradeVolume, price, 10, sl, tp, "S/R Bounce", MagicNumber, 0, clrNONE);

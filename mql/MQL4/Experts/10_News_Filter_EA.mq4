...
#define LICENSE_EA_CODE "news_filter_ea"
...
int OnInit()
{
   ...
   Print("News Filter EA initialized and ready to trade");
   return INIT_SUCCEEDED;
}

void OnDeinit(const int reason)
{
   Print("News Filter EA stopped. Reason: ", reason);
}
...
void OpenOrder(int orderType)
{
   ...
   int ticket = OrderSend(Symbol(), orderType, tradeVolume, price, 10, sl, tp, "Breakout Filter", MagicNumber, 0, clrNONE);
